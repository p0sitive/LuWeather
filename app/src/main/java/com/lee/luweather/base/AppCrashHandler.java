...
/**
 * 自定义系统的Crash捕捉类，用Toast替换系统的对话框 将软件版本信息，设备信息，出错信息保存在sd卡中
 */
public class AppCrashHandler implements UncaughtExceptionHandler {
    ...
    /**
     * 单例模式，保证只有一个AppCrashHandler实例存在
     *
     * @return
     */
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        ...
        // 提示用户程序即将退出
        showToast(mContext, "很抱歉，程序遭遇异常，请重试！");
        try {
            Thread.sleep(2000);
        ...
        ((MyApplication) mContext).removeAll();
    ...
    private String savaInfoToSD(Context context, Throwable ex) {
        ...
        if (Environment.getExternalStorageState().equals(
            ...
            File dir = new File(Constant.getCrashFilePath()
                    + File.separator);
            if (!dir.exists()) {
                dir.mkdir();
            }
